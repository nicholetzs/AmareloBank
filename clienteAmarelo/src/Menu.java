...
public class Menu {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Nicolas Lima");
        System.out.println();
        ...
        if (numero.equals("123456") && senha.equals("admin")) {
            ...
            while (operacao != 8) {
                ...
                operacao = lerInteiro(scanner, "Escolha uma opção: ",
                        "Erro: Opção inválida. Digite um número de 1 a 8.", 1, 8);
                ...
                switch (operacao) {
                    case 1:
                        try {
                            ...
                            double saldo = lerDouble(scanner, "Saldo inicial: R$ ",
                                    "Erro: Saldo deve ser um valor positivo.", 0.0);
                    ...
                    case 2:
                        try {
                            String nomeBusca = lerString(scanner,
                            ...
                            if (cliente != null) {
                                ...
                                System.out.println("Saldo: R$ " +
                                        String.format("%.2f", cliente.getSaldoCliente()));
                            } else {
                    ...
                    case 4:
                        try {
                            int minIdade = lerInteiro(scanner,
                                    "Idade mínima: ",
                                    "Erro: Idade inválida.",
                                    0, 150);

                            int maxIdade = lerInteiro(scanner,
                                    "Idade máxima: ",
                                    "Erro: Idade inválida.",
                                    minIdade, 150);

                            System.out.println("\n--- Clientes na faixa etária entre "
                                    + minIdade + " e " + maxIdade + " anos ---");
                    ...
                    case 5:
                        try {
                            ...
                            System.out.println("Erro na consulta de idades: " + e.getMessage());
                        }
                        break;

                    case 6:
                        try {
                            String nomeExcluir = lerString(scanner,
                    ...
                    case 7:
                        try {
                            String nomeAtualizar = lerString(scanner,
                                    "Digite o nome do cliente para atualizar dados: ",
                                    "Erro: O nome não pode ser vazio.");

                            Cliente clienteAt = arvore.consultar(nomeAtualizar);

                            if (clienteAt != null) {
                                int novaIdade = lerInteiro(scanner,
                                        "Nova idade: ",
                                        "Erro: Idade inválida.",
                                        1, 150);

                                String novoSexo = lerSexo(scanner,
                                        "Novo sexo (M/F): ");

                                double novoSaldo = lerDouble(scanner,
                                        "Novo saldo: R$ ",
                                        "Erro: Saldo inválido.",
                                        0.0);
                    ...
                    case 8:
                        try {
                            ...
                            System.out.println("Erro ao encerrar sistema: " + e.getMessage());
                        }
                        break;
                }
            }
